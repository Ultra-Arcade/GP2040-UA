...
#define BOARD_CONFIG_LABEL "Right Vewlix Module"
...
#define GPIO_PIN_13 GpioAction::BUTTON_PRESS_A2     // A2     | ~      | Capture | ~        | 14     | ~      |
...
#define KEY_DPAD_UP     -1      // UP     | UP     | UP      | UP       | UP     | UP     |
#define KEY_DPAD_DOWN   -1    // DOWN   | DOWN   | DOWN    | DOWN     | DOWN   | DOWN   |
#define KEY_DPAD_RIGHT  -1   // RIGHT  | RIGHT  | RIGHT   | RIGHT    | RIGHT  | RIGHT  |
#define KEY_DPAD_LEFT   -1    // LEFT   | LEFT   | LEFT    | LEFT     | LEFT   | LEFT   |
